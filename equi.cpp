    ...
    ui(new Ui::Equi)
{
    ...
    button1->setGeometry(50, 2, 111, 45);
    button2->setGeometry(170, 2, 111, 45);
    button3->setGeometry(290, 2, 111, 46);
    button4->setGeometry(410, 2, 111, 46);
...
void Equi::on_pushButton_13_clicked()
{
    if (side_menu->width() < 1 ) {
        ...
        sideBarAnimation->setEndValue(QRect(120, 40, 550, 50));
...
void Equi::on_pushButton_11_clicked()
{
    Compte c;
    c.setModal(true);
    c.exec();
